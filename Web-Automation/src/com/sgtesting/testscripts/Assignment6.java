...
public class Assignment6
{
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(5000);
            oBrowser.findElement(By.xpath("//*[@id='customerLightBox_nameField']")).sendKeys("Shivayogi");
			Thread.sleep(5000);
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("Its my New Project");
			Thread.sleep(2000);
